...
export default class Knight {
    ...
    static getMoves(game, from) {
        ChessMove.find({ game, from, movement: Knight.hopForwardLeft, steps: 1 })
        ChessMove.find({ game, from, movement: Knight.hopForwardRight, steps: 1 })
        ChessMove.find({ game, from, movement: Knight.hopRightForward, steps: 1 })
        ChessMove.find({ game, from, movement: Knight.hopRightBackward, steps: 1 })
        ChessMove.find({ game, from, movement: Knight.hopBackwardLeft, steps: 1 })
        ChessMove.find({ game, from, movement: Knight.hopBackwardRight, steps: 1 })
        ChessMove.find({ game, from, movement: Knight.hopLeftForward, steps: 1 })
        ChessMove.find({ game, from, movement: Knight.hopLeftBackward, steps: 1 })
    }
}
